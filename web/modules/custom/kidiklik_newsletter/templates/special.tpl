        ...
        <center class="wrapper" style="width: 100%; table-layout: fixed; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
            <div class="webkit" style="max-width: 600px;">
                ...
                <table class="outer" align="center" style="border-spacing: 0; font-family: Arial, Helvetica, sans-serif; color: #8c8c8c; Margin: 0 auto; width: 100%; max-width: 600px;">
                                ...
                                <tr>
                                    <td class="full-width-image" style="padding: 0;">
                                        <a href="{$newsletter->url}">
                                            <img src="{$site}/images/newsletters/entetes/{$entete}" alt="{$newsletter->titre}" width="600" style="border: 0; width: 100%; height: auto;">
                                        </a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        {if $donnee@index %2 == 0}
                        {if $donnee@first || $donnee@index == 2}    
                        <td class="left-sidebar bloc first" style="padding: 0; text-align: center; font-size: 0; border-top: 0;"> 
                        {else}
                        <td class="left-sidebar bloc" style="padding: 0; text-align: center; font-size: 0; border-top: 2px dotted #ff0000;"> 
                        {/if}
                            <!--[if (gte mso 9)|(IE)]>
                            <table width="100%">
                            <tr>
                            ...
                            <table class="column right" style="border-spacing: 0; font-family: Arial, Helvetica, sans-serif; color: #8c8c8c; width: 100%; display: inline-block; vertical-align: middle; max-width: 335px;">
                                <tr>
                                    <td class="inner contents" style="padding: 15px 10px 15px 10px; width: 100%; font-size: 14px; text-align: left;">
                                        <p class="h2" style="Margin: 0; font-size: 18px; font-weight: bold; Margin-bottom: 9px; color: #000; line-height: 18px;">
                                            <a href="{$donnee->url}" style="text-decoration: none; color: #f00;">
                                                {$donnee->titre}
                                            </a>
                                        </p>
                                        {if $donnee->ss_titre}
                                        <p class="h3" style="Margin: 0; font-size: 12px; font-weight: bold; Margin-bottom: 9px; color: #000; text-transform: uppercase; line-height: 12px;">{$donnee->ss_titre}</p>{/if}
                                        <p class="trait" style="Margin: 0; width: 32px; height: 5px; background-color: #f00; margin-bottom: 9px;">&nbsp;</p>
                                        <p style="Margin: 0;">
                        ...
                        {else}
                       <td class="right-sidebar bloc" dir="rtl" style="padding: 0; text-align: center; font-size: 0; border-top: 2px dotted #ff0000;">
                            <!--[if (gte mso 9)|(IE)]>
                            <table width="100%">
                            <tr>
                            <td width="265">
                            ...
                            <table class="column right" dir="ltr" style="border-spacing: 0; font-family: Arial, Helvetica, sans-serif; color: #8c8c8c; width: 100%; display: inline-block; vertical-align: middle; max-width: 335px;">
                                <tr>
                                    <td class="inner contents" style="padding: 15px 10px 15px 10px; width: 100%; font-size: 14px; text-align: left;">
                                        <p class="h2" style="Margin: 0; font-size: 18px; font-weight: bold; Margin-bottom: 9px; color: #000; line-height: 18px;">
                                            <a href="{$donnee->url}" style="text-decoration: none; color: #f00;">{$donnee->titre}</a></p>
                                        {if $donnee->ss_titre}
                                    ...
                                    <td class="inner full-width-image" style="padding: 15px 10px 15px 10px;">
                                        <p style="Margin: 0; font-size: 14px; Margin-bottom: 10px;">
                                            <a href="{$publicite->url}" style="color: #ee6a56; text-decoration: none;">
                                                <img src="{$site}/images/vendos/{$publicite->image}" alt="{$publicite->titre}" width="600" style="border: 0; width: 100%; height: auto;">
                                            </a>
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" style="border-spacing: 0; font-family: Arial, Helvetica, sans-serif; color: #8c8c8c;">
                                ...
                                <tr>
                                    <td class="inner-full full-width-image" style="padding: 0 10px 0 10px;">
                                        <a href="{$concour->url}" style="color: #ee6a56; text-decoration: none;">
                                            <img src="{$site}/images/{$concour->upload_dir}/{$concour->image}" alt="{$concour->alt}" width="600" style="border: 0; width: 100%; height: auto;">
                                        </a>
                                    </td>
                                </tr>    
                                <tr>
                                    <td class="inner" style="padding: 15px 10px 15px 10px;">
                                        <p class="jouer" style="Margin: 0; font-size: 14px; Margin-bottom: 10px; background-color: #2f9cbe; text-align: center; text-transform: uppercase; text-decoration: none; font-weight: bold; margin-bottom: 0;">
                                            <a href="{$concour->url}" style="color: #fff; text-decoration: none; background-color: #2f9cbe; text-align: center; display: block; padding: 5px;">Jouer</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="one-column" style="padding: 0;">
                            <table class="column cont-footer" align="center" style="border-spacing: 0; font-family: Arial, Helvetica, sans-serif; color: #8c8c8c; margin: 0 auto;">
                                <tr>
                                            ...
                                            <tr>
                                               <td class="inner full-width-image" style="padding: 15px 10px 15px 10px;">
                                                    <a href="{$site}" style="text-decoration: none; color: #8c8c8c;">
                                                        <img src="{$site}/images/newsletters/piaf.png" alt="Aller sur le site kidiklik" style="border: 0; width: 100%; height: auto;"/>
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
